...
#define HEAL_LOCATION_KINGDOM_CITY 23
#define HEAL_LOCATION_BLESSEDCITY 24
#define HEAL_LOCATION_NEW_WORLD 25
#define HEAL_LOCATION_NEW_CITY 26
#define HEAL_LOCATION_ULTRA_METROPOLIS 27
#define HEAL_LOCATION_CLIFFSIDE_CITY 28
