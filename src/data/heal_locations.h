static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_SOUTHERN_ISLAND_EXTERIOR - 1] = {MAP_GROUP(SOUTHERN_ISLAND_EXTERIOR), MAP_NUM(SOUTHERN_ISLAND_EXTERIOR), 18, 32},
    ...
    [HEAL_LOCATION_KINGDOM_CITY - 1] = {MAP_GROUP(KINGDOM_CITY), MAP_NUM(KINGDOM_CITY), 37, 29},
    [HEAL_LOCATION_BLESSEDCITY - 1] = {MAP_GROUP(BLESSEDCITY), MAP_NUM(BLESSEDCITY), 21, 17},
    [HEAL_LOCATION_NEW_WORLD - 1] = {MAP_GROUP(NEW_WORLD), MAP_NUM(NEW_WORLD), 15, 15},
    [HEAL_LOCATION_NEW_CITY - 1] = {MAP_GROUP(NEW_CITY), MAP_NUM(NEW_CITY), 31, 52},
    [HEAL_LOCATION_ULTRA_METROPOLIS - 1] = {MAP_GROUP(ULTRA_METROPOLIS), MAP_NUM(ULTRA_METROPOLIS), 22, 38},
    [HEAL_LOCATION_CLIFFSIDE_CITY - 1] = {MAP_GROUP(CLIFFSIDE_CITY), MAP_NUM(CLIFFSIDE_CITY), 38, 38},
};
