...
static void Task_Enrico(u8);
static void Task_Last_Champion(u8);
...
static const TaskFunc sTasks_Main[B_TRANSITION_COUNT] =
{
    ...
    [B_TRANSITION_ENRICO] = Task_Enrico,
    [B_TRANSITION_LAST_CHAMPION] = Task_Last_Champion, 
...
static const u8 sMugshotsTrainerPicIDsTable[MUGSHOTS_COUNT] =
{
    ...
    [MUGSHOT_ENRICO]   = TRAINER_PIC_LEADER_NORMAN,
    [MUGSHOT_LAST_CHAMPION] = TRAINER_PIC_AQUA_ADMIN_F,
};
static const s16 sMugshotsOpponentRotationScales[MUGSHOTS_COUNT][2] =
{
    ...
    [MUGSHOT_ENRICO] = {0x200, 0x200},
    [MUGSHOT_LAST_CHAMPION] = {0x188, 0x188},
};
...
static const u16 sMugshotPal_Enrico[] = INCBIN_U16("graphics/battle_transitions/leader_norman.gbapal");
static const u16 sMugshotPal_Elena[] = INCBIN_U16("graphics/battle_transitions/aqua_admin_f_bg.gbapal");
...
static const u16 *const sOpponentMugshotsPals[MUGSHOTS_COUNT] =
{
    ...
    [MUGSHOT_ENRICO] = sMugshotPal_Enrico,
    [MUGSHOT_LAST_CHAMPION] = sMugshotPal_Elena
};
...
static void Task_Enrico(u8 taskId)
{
    gTasks[taskId].tMugshotId = MUGSHOT_ENRICO;
    DoMugshotTransition(taskId);
}

static void Task_Last_Champion(u8 taskId)
{
    gTasks[taskId].tMugshotId = MUGSHOT_LAST_CHAMPION;
    DoMugshotTransition(taskId);
}
