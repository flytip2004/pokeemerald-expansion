...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping[] =
{
    ...
    [MAPSEC_CAVE_TOWN] = MAPPOPUP_THEME_STONE2,
    [MAPSEC_KINGDOM_CAVE] = MAPPOPUP_THEME_STONE,
    [MAPSEC_LAVA_RIVER] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_BLESSED_CITY] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_GODS_TOWER] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_UNOVA_ROUTE] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_UNDERWATER_ROUTE] = MAPPOPUP_THEME_STONE,        
    [MAPSEC_KANTO_BEACH] = MAPPOPUP_THEME_WOOD,              
    [MAPSEC_CONNECTING_OCEAN] = MAPPOPUP_THEME_WOOD,          
    [MAPSEC_NEW_MEGATO_CITY] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_TAU_CAVE] = MAPPOPUP_THEME_STONE,
    [MAPSEC_ULTRA_CAVE] = MAPPOPUP_THEME_STONE2,
    [MAPSEC_PURITY_LAKE] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_ULTRA_METROPOLIS] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_SUICUNE_RIVER] = MAPPOPUP_THEME_UNDERWATER,
};
